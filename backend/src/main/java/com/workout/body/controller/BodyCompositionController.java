...
public class BodyCompositionController {
    ...
    public ResponseEntity<Map<String, String>> createBodyComposition(
        ...
        Long bodyCompositionId = bodyCompositionService.createBodyComposition(BodyCompositionDto, userId);
     ...
     */
    @GetMapping("/getInfo")
    public ResponseEntity<List<BodyComposition>> getBodyInfo(@AuthenticationPrincipal UserPrincipal userPrincipal) {
    ...
    public ResponseEntity<?> deleteBodyInfo(@PathVariable("id") Long id, @AuthenticationPrincipal UserPrincipal userPrincipal) {
